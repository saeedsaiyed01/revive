	...
	return (
		...
		>
			...
			<div className="lg:hidden relative z-10 mx-auto px-4 py-8">
				...
				{/* Blog Post Content */}
				<div 
					className="rounded-[25px] shadow-lg p-8"
					style={{
				...
				>
					{/* Blog Post Title */}
					<h2 className="text-white font-isenheim text-2xl text-center mb-8 pt-4">
						{title}
					</h2>

					{/* Blog Content */}
					<div className="text-white font-helvetica text-base leading-relaxed">
						{children}
					</div>
				</div>
			</div>
